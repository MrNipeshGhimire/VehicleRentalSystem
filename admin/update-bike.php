...
<body>
  ...
  <?php
    $bikeid = $_GET['updateid'];
       $sql = "SELECT * from car_bike_table where vehicle_id=$bikeid ";
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <!--=====Fuel type of Vehicle=====-->
                ...
                <div class="form-group">
                    ...
                    <textarea type="textarea" name="overview" value="" style="width:400px; height:78px; outline:none; padding:10px; border:1px solid rgb(216, 206, 206);background-color: #272c4a; color:#fff">
                     <?php echo''.$overview.''?>
                     </textarea>
                </div>
                <div class="form-group">
...
<?php
  if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE car_bike_table set Name='$name', brand='$brand',pricePerDay='$price', fuelType='$fuel',modelYear='$model',seatingCapacity='$seat',image1='$update_filename1',image2='$update_filename2',image3='$update_filename3',Overview='$overview' where vehicle_id=$bikeid ";
    $result = mysqli_query($con,$sql);
    if($result){
        //=====image 1========//

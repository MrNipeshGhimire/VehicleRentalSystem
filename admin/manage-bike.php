...
<body>
    ...
    <?php  include('header-left.php');    ?>
       <div class="dashboard-container-right">  <!-- style.css -->
         ...
         <div class="data-container-1">
            ...
            <table class="data-table">
                ...
                <tr>
                    ...
                    <td>'.$model.'</td>
                    <td>
                        <button  class="btn-1"><a href="update-bike.php?updateid='.$id.'">Update</a></button>
                        <button  class="btn-2"><a href="delete-bike.php?deleteid='.$id.'">Delete</a></button>
                    </td>
                </tr>
                ';
                }
        ...
        <div class="add-new">
            <button type="button" class="btn-1"><a href="add-bike.php">Add New Bike</a></button>
        </div>
    </div>
    </div>
</body>

...
<body>
    ...
    <!---------=====================PHP code================================--> 
       <?php
          ...
          $id = $_GET['bId'];    //get carId  from another page car.php
...
<?php
      ...
      $user_id= $row['user_id'];
      $email = $row['EmailId'];
      $id = $_GET['bId'];    //get carId  from another page car.php //last ko button ma xa link//
...
<div class="vehicle-booking-container-right-side">
    ...
    <form action="" method="POST">
        ...
        <div class="vehicle-booking-container-form">
            <textarea id="booking-messageBox" type="text" name="message" placeholder="Message"></textarea>
        </div>
        <div class="vehicle-booking-container-form">
            <!--===Check if user is logged in or not===============-->
            <?php
